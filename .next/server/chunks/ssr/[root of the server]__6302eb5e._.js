...
;
const metadata = {
    title: "Burhan Metrics",
    description: "An integrated testing and analytics system that helps individuals and companies make informed hiring decisions by assessing skills and providing accurate insights to improve the hiring process and build effective work teams."
};
